...
const AboutCard = () => {
    return (
        <div id="about" className="w-full xl:h-64 lg:h-64 md:h-auto sm:h-auto bg-light_blue flex xl:flex-row lg:flex-row md:flex-col sm:flex-col xl:py-0 lg:py-0 md:py-10 sm:py-10">
